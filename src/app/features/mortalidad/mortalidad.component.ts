...
export class MortalidadComponent implements OnInit, OnDestroy {
  ...
  async loadData(): Promise<void> {
    ...
    for (const l of this.lotes()) {
      const m: any[] = await this.lotService.getMortalidades(l.id!);
      m.forEach(x => x.lote = l);
      all.push(...m);
    }
  ...
  async save(): Promise<void> {
    ...
    await this.lotService.createMortalidad({ ...this.form, fecha: this.form.fecha } as Mortalidad);
